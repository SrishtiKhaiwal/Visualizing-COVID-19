...
# Label the y-axis
p<-ggplot(confirmed_cases_worldwide,aes(x=date,y=cum_cases)) + geom_line()
p + labs(y="Cumulative confirmed cases")
...
ggplot(confirmed_cases_top7_outside_china,aes(date,cum_cases,color=country,group=country))+geom_line()+
  ylab("Cumulative confirmed cases")
